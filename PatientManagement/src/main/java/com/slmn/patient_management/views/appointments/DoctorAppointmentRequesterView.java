...
public class DoctorAppointmentRequesterView extends ViewWithFrame  {
    ...
    public DoctorAppointmentRequesterView() {
        loadBoxes();

        cbxPatient.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                patient = SystemDatabase.connect().patients.get(cbxPatient.getSelectedIndex());
                regenTimeslots();
            }
        });
        ...
        btnRequest.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                AppointmentRequest request = controller.requestAppointment((Doctor) Main.authenticatedUser, patient, getDate(), controller.generateTimeSlots(getDate()).get(cbxTimeslot.getSelectedIndex()));
                if (request != null) {
    ...
    public void regenTimeslots() {
        ...
        if (this.patient == null) {
            ...
            for (TimeSlot timeslot : this.controller.generateOccupiedTimeSlots(getDate(), (Doctor) Main.authenticatedUser)) {
    ...
    public SwitchableFrame getFrame() {
        return new SubFrame("Appointment Requester", this.mainPanel, new DoctorMainMenu());
    }
}
